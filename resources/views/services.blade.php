				...
				<div class="row">
					<div class="col-md-10">
						<div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
							<div class="image_wrapper"><img class="scale-with-grid" src="{{ asset('images/agency4-services-icon1.png')}}" alt="agency4-services-icon1" width="780" height="785"> </div>
						</div>
					</div>
				</div>
			</div>
...
<div class="section">
	<div class="container">
		<div class="row">
			<div class="col-md-6" style="padding:40px 2%">
				<div class="column_attr clearfix mobile_align_center">
					...
					<p style="color:#ADADC1;margin:0"> 
						...
						We bring years of experience and in-depth technical expertise in managing IT installments for small, medium and large size enterprises. We help in designing IT strategy for businesses to complement the long term business goals. Our services cover planning, implementing and supporting the IT installations for enterprises. We bring a wide range of robust, reliable and cost-effective IT infrastructure services including the supply of all standard types of networking equipment and offer security solutions including CCTV, identity management, risk analysis, protection plans, as well as providing implementation structure such as encryption, remote access, ﬁrewalls.
					</p>
					<hr class="no_line" style="margin: 0 auto 20px auto">										
			...
			<div class="col-md-6" style="padding:40px 2%">
				<div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
					<div class="image_wrapper"><img class="scale-with-grid" src="{{ asset('images/agency4-services-icon2.png')}}" alt="agency4-services-icon2" width="350" height="785"> </div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-6" style="padding:40px 2%">
				<div class="row">
					<div class="col-md-10">
						<div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
							<div class="image_wrapper"><img class="scale-with-grid" src="{{ asset('images/agency4-services-icon3.png')}}" alt="agency4-services-icon1" width="780" height="785"> </div>
						</div>
					</div>
				</div>
			</div>
...
<div class="section">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6" style="padding:40px 2%">
				<div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
					<div class="image_wrapper"><img class="scale-with-grid" src="{{ asset('images/agency4-contact-icon3.png')}}" alt="agency4-services-icon2" width="350" height="785"> </div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-md-6" style="padding:40px 2%">
				<div class="row">
					<div class="col-md-10">
						<div class="image_frame image_item no_link scale-with-grid aligncenter no_border">
							<div class="image_wrapper"><img class="scale-with-grid" src="{{ asset('images/agency4-contact-icon2.png')}}" alt="agency4-services-icon1" width="780" height="785"> </div>
						</div>
					</div>
				</div>
			</div>
